            ...
            <div class="body">
                <div class="container">
                    <div class="container p-3 m-4 h-100"
                        ...
                        <hr>
                        <form action="../process/addreviewProcess.php" method="post">
                            <input type="hidden" name="email" value="<?php echo $u['email'] ?>">
                            <input type="hidden" name="namaReview" value="<?php echo $u['username'] ?>">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Username</label>
                                <input class="form-control" id="namaReview" name="namaReview" aria-describedby="emailHelp"
                                    value="<?php echo $u['username'] ?>" disabled>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary" name="addReview">Submit Review</button>
                            </div>
                        </form>
                    </div>
                </div>
