<?php
    ...
    if(!isset($_SESSION['email'])){
        ...
        echo '<script>
            alert("Anda sudah login!"); window.location = "../page/profilPage.php"
            </script>';
    }
?>
            ...
            <div class="col-6">
                <div class="row">
                    <div class="card card-login mx-auto" style="height:100vh">
                        ...
                        <div class="card-body">
                            <form action="../process/loginProses.php" method="post">
                            ...
                            <div class="text-center">
                                <a class="d-block small mt-3" href="../page/register.php">Register an Account</a>
